...
connect_debug_port u_ila_0/probe0 [get_nets [list {cnt_reg[22]} {cnt_reg[23]} {cnt_reg[24]} {cnt_reg[25]} {cnt_reg[26]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 4 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {pwm_inp[0]} {pwm_inp[1]} {pwm_inp[2]} {pwm_inp[3]}]]
